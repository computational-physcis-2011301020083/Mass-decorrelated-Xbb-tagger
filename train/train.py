...
train_file=h5py.File("../DataVRGhost/PrepareData/trainstd.h5","r")
...
def define_model(params):
    inputs=Input(shape=(74, ), name='WeiAdm3bStd1')
...
params = {'num_layers': 6,'num_units': 250,'activation_type': 'relu','dropout_strength': 0.2,'learning_rate': 0.01,'lr_decay': 0.00001,'epochs': 300,'batch_norm': True,'output_size': 3,}   

model = define_model(params)
model_name ="WeiAdm3bStd1"
save_path = "./"
batchsize=10000
